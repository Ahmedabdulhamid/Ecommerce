<form class="number-tab-steps wizard-circle" enctype="multipart/form-data" wire:submit.prevent='submit'>
    ...
    <fieldset class="@if ($currentStep != 2) displayNone @endif">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="has_variants">{{__('admin.has_variants')}} :</label>
        ...
        <div class="row">
            @if ($has_variants == 1 && $manage_stock==0)
                <hr class="bf-black">
                @if (count($prices) > 0)
