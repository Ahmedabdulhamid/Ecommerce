                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1"
                                            src="{{ asset('assets') }}/images/slider/slider-2.png" alt="First slide"><a
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#"><i class="ft-align-left"></i> Multi level menu</a>
                                                <ul>
                                                    ...
                                                    <li><a class="dropdown-item" href="#"><i
                                                                class="la la-hdd-o"></i> Second level, third link</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="#"><i
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list w-100">
                                ...
                                @if ($notification->type=='CreateOrderNotification')
                                    <a href="{{ route('orders.show', ['id' => $notification->data['order_id']]) }}?notify-order={{ $notification->id }}">
                                        <div class="media">
                                            <div class="media-left align-self-center"><i
                                                    class="ft-plus-square icon-bg-circle bg-cyan"></i></div>
                                            <div class="media-body">
                                                <h6 class="media-heading">{{$notification->data['message']}}</h6>
                                                <p class="notification-text font-small-3 text-muted">Order From {{$notification->data['user_name']}}  {{number_format($notification->data['total_price'])}} EGP</p>
                                                <small>
                                                    <time class="media-meta text-muted"
                                                        datetime="2015-06-11T18:29:20+08:00"> {{$notification->created_at->diffForHumans()}} </time>
                                                </small>
                                            </div>
                                        </div>
                                    </a>
                                    @elseif ($notification->type=='CreateContactNotification')
                                    <a href="{{route('contacts.index')}}?notify-contact={{$notification->id}}">
                                        <div class="media">
                                            <div class="media-left align-self-center"><i
                                                    class="ft-alert-triangle icon-bg-circle bg-yellow bg-darken-3"></i></div>
                                            <div class="media-body">
                                                <h6 class="media-heading">{{$notification->data['custom_message']}}</h6>
                                                <p class="notification-text font-small-3 text-muted">Contact From {{$notification->data['name']}}</p>
                                                <small>
                                                    <time class="media-meta text-muted"
                                                        datetime="2015-06-11T18:29:20+08:00"> {{$notification->created_at->diffForHumans()}} </time>
                                                </small>
