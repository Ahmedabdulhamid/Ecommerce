...
<button class="btn btn-info btn-min-width btn-glow "data-bs-toggle="modal" data-bs-target="#slider_{{$slider->id}}" >Edit</button>
...
<button type="button" class="btn btn-danger btn-min-width btn-glow  del"id={{$slider->id}}>Delete</button>
<script>
