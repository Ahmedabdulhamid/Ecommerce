...
@endphp
@section('title',__('admin.pages_table'))
<!DOCTYPE html>
...
<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click"
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">{{__('admin.pages_table')}}</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin.pages_table')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header ">
                                <h4 class="card-title">{{ __('admin.pages_table') }}</h4>
                            ...
                            <div class="card-content">
                                <div class="my-5 container d-flex justify-content-between">
                                    <a href="{{ route('pages.create') }}"
                                        class="btn btn-primary ">{{ __('sliders.create_page') }}</a
                                        href="{{ route('pages.create') }}">


                                </div>
                                <div class="table-responsive">
                                    <table class="table mb-0 "id="Page_table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>{{ __('sliders.titel_ar') }}</th>
    ...
    <script>
        ...
        $('#Page_table tbody').on('click', 'td.dt-control', function() {
