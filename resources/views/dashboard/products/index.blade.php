...
@endphp
@section('title',__('admin.products_page'))
<!DOCTYPE html>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header ">
                                <h4 class="card-title">{{ __('admin.product_table') }}</h4>
                            ...
                            <div class="card-content">
                                <div class="my-5 container d-flex justify-content-between">
                                    <a href="{{ route('products.create') }}"class="btn btn-primary ">{{__('admin.create_product')}}</a>
