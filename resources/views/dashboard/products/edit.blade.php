...
@endphp
@section('title',__('admin.edit_products_page'))
<!DOCTYPE html>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                             @livewire('admin.products.update-data',['attributes'=>$attributes,'categories'=>$categories,'brands'=>$brands,'product'=>$product])
                            </div>
                        </div>
                    </div>
                </div>
