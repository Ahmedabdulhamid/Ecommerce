<head>
    ...
    <link rel="icon" href="{{ asset('front-assets') }}/images/homepage-one/icon.png">
    ...
    <link rel="stylesheet" href="{{ asset('front-assets') }}/css2/aos-3.0.0.css"style="direction: rtl;">

    <link rel="stylesheet" href="{{ asset('front-assets') }}/css2/style.css"style="direction: rtl;">
