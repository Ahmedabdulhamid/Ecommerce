                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                <div class="product-img">
                                    <img src="{{ asset('storage/products/' . $item->images->first()->file_name) }}"
                                        alt="{{ $item->getTranslation('name', 'en') }}">
                                    <div class="product-cart-items">
                                        <a href="{{ route('getProductDetails', $item->slug) }}" class="cart cart-item">
                                            <span>
                                ...
                                <div class="product-cart-btn">
                                    <a href="cart.html"
                                        class="product-btn">{{ $item->category->getTranslation('name', app()->getLocale()) }}</a>
                                </div>
                            </div>
                        </div>
                    @empty
