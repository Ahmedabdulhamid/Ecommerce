@section('title',__('front.prdoduct_details_page'))
<!DOCTYPE html>
<html lang="en">
    ...
    <section class="product weekly-sale product-weekly footer-padding">
        <div class="container">
            <div class="section-title">
                <h5>{{ __('front.related_products') }}</h5>
                <a href="#" class="view">{{ __('front.view_all') }}</a>
            </div>
            <div class="weekly-sale-section">
                <div class="row g-5">
                    ...
                    @empty
                        <span class="text-center"> <p>{{__('front.no_products_found')}}</p></span>
                    @endforelse
