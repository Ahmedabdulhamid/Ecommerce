                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="product-wrapper position-relative" data-aos="fade-up">
                                    <div class="product-img">
                                        ...
                                        <div class="product-cart-items">
                                            <a href="href="{{ route('getProductDetails', $product->slug) }}""
                                                class="cart cart-item">
                                                <span>
                                                    <svg width="40" height="40" viewBox="0 0 40 40"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="product top-selling">
        <div class="container">
            <div class="section-title">
                ...
                <a href="product-sidebar.html" class="view">{{ __('front.view_all') }}</a>
            </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('front-assets') }}/images/homepage-one/product-img/product-img-5.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('front-assets') }}/images/homepage-one/product-img/product-img-6.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('front-assets') }}/images/homepage-one/product-img/product-img-7.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('front-assets') }}/images/homepage-one/product-img/product-img-8.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('front-assets') }}/images/homepage-one/product-img/product-img-10.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
    ...
    <section class="product best-seller">
        <div class="container">
            <div class="best-selling-section">
                <div class="section-title">
                    <h5>{{ __('front.best_sellers') }}</h5>
                    <a href="sellers.html" class="view">{{ __('front.view_all') }}</a>
                </div>
            ...
            <div class="weekly-sale-section">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('front-assets') }}/images/homepage-one/product-img/product-img-9.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
        ...
        <div class="container">
            ...
            <div class="best-product-section">
                <div class="row ">
                    ...
                    @empty
                        <span class="text-center">No Products Found</span>
                    @endforelse
