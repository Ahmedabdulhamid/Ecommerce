...
Route::prefix(LaravelLocalization::setLocale())->middleware(['localeSessionRedirect', 'localizationRedirect', 'localeViewPath','guest'])->group(function () {
    ...
    Route::post('reset-password', [NewPasswordController::class, 'store'])
                ...
                Route::get('verify-email/{id}/{hash}', [CustomVerifyEmailController::class,'verifyEmail'])
